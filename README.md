...
My path is `C:\opencv\build\x64\vc15\bin\opencv_createsamples.exe`.
...
```
For Windows, you might use `YOURPATH\opencv\build\x64\vc15\bin\opencv_traincascade.exe`. My path is `C:\opencv\build\x64\vc15\bin\opencv_traincascade.exe`
